...
import styles from "../../add/bookingform.module.css";
    ...
    useEffect(() => {
        async function fetchBooking() {
            ...
            setFormData({
                ...
                advance_amount: booking.advance_amount ? String(booking.advance_amount) : "",
